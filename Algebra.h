...
public:
	...
	bool is_precision_reached() const { return reached_precision < precision; }
	uint_t get_used_iter() const { return used_iteration_count; }
	uint_t get_check_interval() const { return check_interval; }
};
